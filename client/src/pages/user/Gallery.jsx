...
import Pagination from "../../components/commom/Pagination"; // นำเข้า Pagination
...
const Gallery = () => {
  ...
  const itemsPerPage = 8; // กำหนดจำนวนอัลบั้มต่อหน้า (เช่น 8 อัลบั้ม)
  ...
  const handlePageChange = (pageNumber) => {
    ...
    // เลื่อนหน้าจอขึ้นไปบนสุดของส่วนเนื้อหาเมื่อเปลี่ยนหน้า
        ...
        <section className="relative pt-32 pb-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center text-white">
                ...
                <p className="text-lg md:text-xl text-orange-50 max-w-2xl mx-auto font-light leading-relaxed">
                    รวบรวมภาพความประทับใจในงานบุญและกิจกรรมต่างๆ เพื่อให้ศรัทธาสาธุชนได้ร่วมอนุโมทนาบุญ
                </p>
            </div>
                          ...
                          return (
                              ...
                              >
                                  <div className="aspect-4/3 overflow-hidden relative">
                                      ...
                                      <div className="absolute top-4 right-4 bg-black/40 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                          ดูรูปภาพ
                                      </div>
